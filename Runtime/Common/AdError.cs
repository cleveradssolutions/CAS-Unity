...
namespace CAS
{
    public enum AdError
    {
        ...
        ReachedCap = 1004,
        /// <summary>
        /// There is not enough space in the current view for the selected <see cref="AdSize"/>.
        /// <para>Please make sure that the size of the banner container has enough free space.</para>
        /// </summary>
        NotEnoughSpace = 1005,
        /// <summary>
